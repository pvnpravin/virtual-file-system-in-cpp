              ...
              )
{
    ...
    for (i = 0; i < MAXOPENFILES; i++)
    {
        if(uareaObj.UFDT[i] != NULL)
        {
            ...
            {
                // De-allocate the memory of Buffer
                ...
                // De-allocate memory of file table
...
// Output       : Number of bytes sucessfully written
// Author       : Pravin Ashok Chavan
// Date         : 22/01/2026
//
/////////////////////////////////////////////////////////////////////////
    ...
    while (1)
    {
        ...
        else if (iCount == 2)
        {
            ...
            else if ((strcmp("write", Command[0])) == 0)
            {
                ...
                iRet = WriteFile(atoi(Command[0]), InputBuffer,strlen(InputBuffer)-1);
            }
            else
            {
